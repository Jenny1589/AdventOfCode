...
export let
    day01 = fs.readFileSync('../files/day01_puzzleData.txt').toString().split('\r\n'),
    day02 = fs.readFileSync('../files/day02_puzzleData.txt').toString().split('\r\n'),
    day03 = fs.readFileSync('../files/day03_puzzleData.txt').toString().split('\r\n'),
    day04 = fs.readFileSync('../files/day04_puzzleData.txt').toString().split('\r\n'),
